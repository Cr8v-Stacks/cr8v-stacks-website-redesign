<?php
/**
 * Template Name: Case Study — Stride Plus Media
 * Prototype Parity: Case Studies/stride-plus-media.html (100% Exact Duplication)
 */
...
<div class="c8cs-root">
  ...
  <section class="c8cs-hero">
    ...
    <div class="c8cs-wrap" style="padding-top: 1rem; padding-bottom: 2rem;">
      ...
      <div class="c8cs-label">Case Study // Media &amp; Paid Growth</div>
      <h1 class="c8cs-headline">Stride Plus Media: Brand Strategy <span class="c8cs-serif">&amp; Paid Acquisition</span></h1>
      <p class="c8cs-lead">Stride Plus Media needed to expand listener acquisition for Stride Radio. We architected a multi-channel digital marketing engine combining targeted Meta Ads, Google Ads search campaigns, and conversion tracking to scale audience retention.</p>
      
      <div class="fylla-pill-row">
        <span class="fylla-pill">Digital Marketing</span>
        <span class="fylla-pill">Meta Ads</span>
        <span class="fylla-pill">Google Ads</span>
        <span class="fylla-pill">Conversion Funnels</span>
      </div>

      <div class="c8cs-meta-grid">
        <div class="c8cs-meta-item">
          <span class="c8cs-meta-lbl">Client</span>
          <span class="c8cs-meta-val">Stride Radio</span>
        </div>
        <div class="c8cs-meta-item">
          <span class="c8cs-meta-lbl">Services</span>
          <span class="c8cs-meta-val">Digital Marketing &amp; Strategy</span>
        </div>
        <div class="c8cs-meta-item">
          <span class="c8cs-meta-lbl">Stack</span>
          <span class="c8cs-meta-val">Meta Ads · Google Ads · GTM</span>
        </div>
        <div class="c8cs-meta-item">
          <span class="c8cs-meta-lbl">Link</span>
          <span class="c8cs-meta-val"><a href="https://strideradio.ng/" target="_blank" rel="noopener" style="color: #0047E1; text-decoration: underline;">strideradio.ng ↗</a></span>
        </div>
      </div>
    </div>
  </section>
  ...
  <div class="c8cs-grow-media-wrapper" id="c8cs-grow-trigger">
    <div class="c8cs-main-img-box" id="c8cs-grow-target">
      <img src="https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?q=80&w=1600&auto=format&fit=crop" alt="Stride Plus Media showcase — built by Cr8v Stacks">
    </div>
  </div>
    ...
    <div class="c8cs-split-section">
      <div class="c8cs-split-left">
        ...
        <div class="c8cs-body-content">
          <p>Stride Radio was looking to break through noisy digital media markets and capture loyal daily listeners without wasting budget on broad, un-targeted ad impressions.</p>
          <p>They needed server-side tracking infrastructure, high-converting ad creative copy, and audience segment funnels tailored to music and broadcast enthusiasts.</p>
        </div>
      </div>
      ...
      <div class="c8cs-split-right">
        <div class="fylla-value-item">
          ...
          <div>
            <h3 class="fylla-value-h3">01 / Audience Persona &amp; Market Mapping</h3>
            <p class="fylla-value-desc">Identified primary listener demographics, micro-interests, and media consumption habits across key regions.</p>
          </div>
        </div>
        <div class="fylla-value-item">
          <div class="fylla-value-icon-box">
          ...
          <div>
            <h3 class="fylla-value-h3">02 / Multi-Channel Paid Ad Setup</h3>
            <p class="fylla-value-desc">Configured hyper-targeted Google Search and Meta Video ad campaigns with strict CPA caps.</p>
          </div>
        </div>
        <div class="fylla-value-item">
          <div class="fylla-value-icon-box">
          ...
          <div>
            <h3 class="fylla-value-h3">03 / Server-Side Tracking &amp; GTM</h3>
            <p class="fylla-value-desc">Deployed Google Tag Manager server-side tracking to capture 100% of conversion signals past iOS restrictions.</p>
          </div>
        </div>
        <div class="fylla-value-item">
          <div class="fylla-value-icon-box">
          ...
          <div>
            <h3 class="fylla-value-h3">04 / Creative A/B Testing Engine</h3>
            <p class="fylla-value-desc">Tested audio snippets, video teasers, and static display copy to optimize click-through rates (CTR).</p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="c8cs-gallery-grid">
          <div class="c8cs-gallery-card">
            <div class="c8cs-gallery-card-top">
              <div class="c8cs-gallery-meta">Campaign Analytics // Asset 01</div>
              <h3 class="c8cs-gallery-title">Paid Acquisition Dashboard</h3>
            </div>
            <div class="c8cs-gallery-card-bottom">
              <p class="c8cs-gallery-desc">Real-time attribution tracking, campaign ROAS analytics, and multi-channel conversion funnels.</p>
              <div class="c8cs-gallery-img-box">
                <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=800&auto=format&fit=crop" alt="Stride Plus Media analytics dashboard screenshot">
              </div>
            </div>
          </div>
          ...
          <div class="c8cs-gallery-card">
            ...
            <div class="c8cs-gallery-card-bottom">
              ...
              <div class="c8cs-gallery-img-box">
                <img src="https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?q=80&w=800&auto=format&fit=crop" alt="Stride Plus Media interface detail screenshot">
              </div>
            </div>
          </div>
          ...
          <div class="c8cs-gallery-card is-full">
            ...
            <div class="c8cs-gallery-card-bottom">
              ...
              <div class="c8cs-gallery-img-box is-tall">
                <img src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?q=80&w=1200&auto=format&fit=crop" alt="Stride Plus Media mobile experience flow">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="c8cs-metrics-outer-box">
        ...
        <div class="c8cs-metrics-grid">
          <div class="c8cs-metric-card">
            <div class="c8cs-metric-val">+320%</div>
            <div class="c8cs-metric-lbl">Monthly Listener Growth</div>
            <p class="c8cs-metric-desc">Scaled verified streaming sessions across broadcast channels within 90 days of campaign launch.</p>
          </div>
          <div class="c8cs-metric-card">
            <div class="c8cs-metric-val">2.4x</div>
            <div class="c8cs-metric-lbl">Ad Spend Efficiency</div>
            <p class="c8cs-metric-desc">Reduced acquisition cost per listener through continuous creative and audience bid optimization.</p>
          </div>

          <div class="c8cs-metric-card">
            <div class="c8cs-metric-lbl" style="margin-bottom: 1.5rem;">Live Verification</div>
            <a href="https://strideradio.ng/" target="_blank" rel="noopener" class="c8cs-status-badge">
    ...
    <div class="c8cs-wrap" style="padding-top:0; padding-bottom:0;">
      <div class="c8cs-related-matrix-box">
        ...
        <div class="c8cs-related-matrix-grid">
          <a href="<?php echo esc_url(home_url('/portfolio/sweetermen-ng/')); ?>" class="c8cs-related-cell">
            <div>
              <div class="c8cs-related-cell-tag">01 / WooCommerce &amp; Paid Ads</div>
              <h3 class="c8cs-related-cell-title">SweeterMen NG</h3>
              <p class="c8cs-related-cell-desc">Full-stack luxury watch e-commerce store with custom checkout hooks and paid Meta/Google ad campaigns.</p>
            </div>
            <span class="c8cs-related-cell-link">Explore Case Study &rarr;</span>
          </a>
          <a href="<?php echo esc_url(home_url('/portfolio/bridgepoints/')); ?>" class="c8cs-related-cell">
            <div>
              <div class="c8cs-related-cell-tag">02 / Brand Identity Design</div>
              <h3 class="c8cs-related-cell-title">BridgePoints Brand Identity</h3>
              <p class="c8cs-related-cell-desc">High-trust corporate visual identity system, vector logo marks, typography scales, and Figma guidelines.</p>
            </div>
            <span class="c8cs-related-cell-link">Explore Case Study &rarr;</span>
          </a>
