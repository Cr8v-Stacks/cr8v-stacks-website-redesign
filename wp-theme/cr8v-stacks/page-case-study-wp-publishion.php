<?php
/**
 * Template Name: Case Study — WP Publishion AI
 * Prototype Parity: Case Studies/wp-publishion-ai.html (100% Exact Duplication)
 */
...
<div class="c8cs-root">
  ...
  <section class="c8cs-hero">
    ...
    <div class="c8cs-wrap" style="padding-top: 1rem; padding-bottom: 2rem;">
      ...
      <div class="c8cs-label">Case Study // Artificial Intelligence &amp; SaaS</div>
      <h1 class="c8cs-headline">WP Publishion AI: Autonomous Content <span class="c8cs-serif">Engine SaaS</span></h1>
      <p class="c8cs-lead">WP Publishion AI is a cutting-edge SaaS platform that automates high-authority editorial publishing. We built the full AI MVP combining Python FastAPI backend pipelines, Claude &amp; OpenAI API routing, and Supabase pgvector database retrieval.</p>
      
      <div class="fylla-pill-row">
        <span class="fylla-pill">AI MVP Dev</span>
        <span class="fylla-pill">FastAPI &amp; Python</span>
        <span class="fylla-pill">Supabase Vector</span>
        <span class="fylla-pill">Multi-LLM</span>
      </div>

      <div class="c8cs-meta-grid">
        <div class="c8cs-meta-item">
          <span class="c8cs-meta-lbl">Client</span>
          <span class="c8cs-meta-val">WP Publishion AI</span>
        </div>
        <div class="c8cs-meta-item">
          <span class="c8cs-meta-lbl">Services</span>
          <span class="c8cs-meta-val">AI MVP Development</span>
        </div>
        <div class="c8cs-meta-item">
          <span class="c8cs-meta-lbl">Stack</span>
          <span class="c8cs-meta-val">Python · FastAPI · Supabase</span>
        </div>
        <div class="c8cs-meta-item">
          <span class="c8cs-meta-lbl">Link</span>
          <span class="c8cs-meta-val"><a href="https://cr8vstacks.com/dev-playground/wp-publishion-ai/" target="_blank" rel="noopener" style="color: #0047E1; text-decoration: underline;">Sandbox Playground ↗</a></span>
        </div>
      </div>
    </div>
  </section>
  ...
  <div class="c8cs-grow-media-wrapper" id="c8cs-grow-trigger">
    <div class="c8cs-main-img-box" id="c8cs-grow-target">
      <img src="https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?q=80&w=1600&auto=format&fit=crop" alt="WP Publishion AI showcase — built by Cr8v Stacks">
    </div>
  </div>
    ...
    <div class="c8cs-split-section">
      <div class="c8cs-split-left">
        ...
        <div class="c8cs-body-content">
          <p>Traditional content creation workflows suffer from bottlenecked production times and high agency costs. The client envisioned an AI engine capable of generating research-backed, SEO-ready articles automatically.</p>
          <p>The system required multi-model fallback logic (Claude 3.5 Sonnet + GPT-4o), vector database RAG grounding, and automatic WordPress REST API posting.</p>
        </div>
      </div>
      ...
      <div class="c8cs-split-right">
        <div class="fylla-value-item">
          ...
          <div>
            <h3 class="fylla-value-h3">01 / Python FastAPI Architecture</h3>
            <p class="fylla-value-desc">Engineered asynchronous API backend services capable of processing complex prompt pipelines concurrently.</p>
          </div>
        </div>
        <div class="fylla-value-item">
          <div class="fylla-value-icon-box">
          ...
          <div>
            <h3 class="fylla-value-h3">02 / Vector Embeddings &amp; RAG</h3>
            <p class="fylla-value-desc">Integrated Supabase pgvector to store domain-specific context embeddings for accurate model retrieval.</p>
          </div>
        </div>
        <div class="fylla-value-item">
          <div class="fylla-value-icon-box">
          ...
          <div>
            <h3 class="fylla-value-h3">03 / Multi-LLM Model Routing</h3>
            <p class="fylla-value-desc">Built intelligent router logic to select optimal LLMs based on task complexity, token limits, and speed requirements.</p>
          </div>
        </div>
        <div class="fylla-value-item">
          <div class="fylla-value-icon-box">
          ...
          <div>
            <h3 class="fylla-value-h3">04 / Automated WordPress Integration</h3>
            <p class="fylla-value-desc">Connected webhooks to automatically format markdown content and publish directly into client WordPress sites.</p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="c8cs-gallery-grid">
          <div class="c8cs-gallery-card">
            <div class="c8cs-gallery-card-top">
              <div class="c8cs-gallery-meta">AI Engine Architecture // Asset 01</div>
              <h3 class="c8cs-gallery-title">Autonomous Content Pipeline</h3>
            </div>
            <div class="c8cs-gallery-card-bottom">
              <p class="c8cs-gallery-desc">Neural network model routing, automated SEO schema generator, and real-time WP-REST publishing pipeline.</p>
              <div class="c8cs-gallery-img-box">
                <img src="https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?q=80&w=800&auto=format&fit=crop" alt="WP Publishion AI engine dashboard screenshot">
              </div>
            </div>
          </div>
          ...
          <div class="c8cs-gallery-card">
            ...
            <div class="c8cs-gallery-card-bottom">
              ...
              <div class="c8cs-gallery-img-box">
                <img src="https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?q=80&w=800&auto=format&fit=crop" alt="WP Publishion AI interface detail screenshot">
              </div>
            </div>
          </div>
          ...
          <div class="c8cs-gallery-card is-full">
            ...
            <div class="c8cs-gallery-card-bottom">
              ...
              <div class="c8cs-gallery-img-box is-tall">
                <img src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?q=80&w=1200&auto=format&fit=crop" alt="WP Publishion AI mobile experience flow">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="c8cs-metrics-outer-box">
        ...
        <div class="c8cs-metrics-grid">
          <div class="c8cs-metric-card">
            <div class="c8cs-metric-val">10x</div>
            <div class="c8cs-metric-lbl">Publishing Velocity</div>
            <p class="c8cs-metric-desc">Reduced article generation and publishing times from hours down to under 60 seconds.</p>
          </div>
          <div class="c8cs-metric-card">
            <div class="c8cs-metric-val">100%</div>
            <div class="c8cs-metric-lbl">Proprietary IP</div>
            <p class="c8cs-metric-desc">Client owns every line of backend Python code, custom system prompts, and vector pipeline configurations.</p>
          </div>

          <div class="c8cs-metric-card">
            <div class="c8cs-metric-lbl" style="margin-bottom: 1.5rem;">Live Verification</div>
            <a href="https://cr8vstacks.com/dev-playground/wp-publishion-ai/" target="_blank" rel="noopener" class="c8cs-status-badge">
      ...
      <div class="c8cs-related-matrix-box">
        ...
        <div class="c8cs-related-matrix-grid">
          <a href="<?php echo esc_url(home_url('/portfolio/bridgepoint-compliance/')); ?>" class="c8cs-related-cell">
            <div>
              <div class="c8cs-related-cell-tag">01 / Custom Dev</div>
          ...
          <a href="<?php echo esc_url(home_url('/portfolio/blvck-hair-ng/')); ?>" class="c8cs-related-cell">
            <div>
              <div class="c8cs-related-cell-tag">02 / SEO &amp; Content Strategy</div>
          ...
          <a href="<?php echo esc_url(home_url('/portfolio/stride-plus-media/')); ?>" class="c8cs-related-cell">
            <div>
              <div class="c8cs-related-cell-tag">03 / Digital Marketing</div>
