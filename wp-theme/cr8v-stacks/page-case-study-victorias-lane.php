<?php
/**
 * Template Name: Case Study — Victoria's Lane
 * Prototype Parity: Case Studies/victorias-lane.html (100% Exact Duplication)
 */
...
<div class="c8cs-root">
  ...
  <section class="c8cs-hero">
    ...
    <div class="c8cs-wrap" style="padding-top: 1rem; padding-bottom: 2rem;">
      ...
      <div class="c8cs-label">Case Study // Fashion &amp; Shopify Liquid</div>
      <h1 class="c8cs-headline">Victoria's Lane: Shopify Storefront <span class="c8cs-serif">&amp; Liquid Dev</span></h1>
      <p class="c8cs-lead">Victoria's Lane is an exclusive luxury handbag brand. We hand-coded a bespoke Shopify Liquid storefront featuring custom product filters, an app-free AJAX cart drawer, and high-converting PDP visual showcases.</p>
      
      <div class="fylla-pill-row">
        <span class="fylla-pill">Shopify Liquid</span>
        <span class="fylla-pill">Custom Theme</span>
        <span class="fylla-pill">AJAX Cart</span>
        <span class="fylla-pill">Fashion CRO</span>
      </div>

      <div class="c8cs-meta-grid">
        <div class="c8cs-meta-item">
          <span class="c8cs-meta-lbl">Client</span>
          <span class="c8cs-meta-val">Victoria's Lane</span>
        </div>
        <div class="c8cs-meta-item">
          <span class="c8cs-meta-lbl">Services</span>
          <span class="c8cs-meta-val">Shopify Storefront &amp; CRO</span>
        </div>
        <div class="c8cs-meta-item">
          <span class="c8cs-meta-lbl">Stack</span>
          <span class="c8cs-meta-val">Shopify · Liquid · JavaScript</span>
        </div>
        <div class="c8cs-meta-item">
          <span class="c8cs-meta-lbl">Link</span>
          <span class="c8cs-meta-val"><a href="https://victoriaslane.com/" target="_blank" rel="noopener" style="color: #0047E1; text-decoration: underline;">victoriaslane.com ↗</a></span>
        </div>
      </div>
    </div>
  </section>
  ...
  <div class="c8cs-grow-media-wrapper" id="c8cs-grow-trigger">
    <div class="c8cs-main-img-box" id="c8cs-grow-target">
      <img src="https://images.unsplash.com/photo-1548036328-c9fa89d128fa?q=80&w=1600&auto=format&fit=crop" alt="Victoria's Lane showcase — built by Cr8v Stacks">
    </div>
  </div>
    ...
    <div class="c8cs-split-section">
      <div class="c8cs-split-left">
        ...
        <div class="c8cs-body-content">
          <p>Victoria's Lane needed a storefront that reflected high fashion elegance without falling into generic Shopify theme templates or app bloat fees.</p>
          <p>They required custom Liquid template logic for variant swatches, high-resolution product video showcases, and instant cart drawer slideouts.</p>
        </div>
      </div>
      ...
      <div class="c8cs-split-right">
        <div class="fylla-value-item">
          ...
          <div>
            <h3 class="fylla-value-h3">01 / Custom Shopify Liquid Architecture</h3>
            <p class="fylla-value-desc">Hand-coded custom Liquid templates from a blank canvas with zero third-party page builder plugins.</p>
          </div>
        </div>
        <div class="fylla-value-item">
          <div class="fylla-value-icon-box">
          ...
          <div>
            <h3 class="fylla-value-h3">02 / Custom Variant Swatch Engine</h3>
            <p class="fylla-value-desc">Built dynamic JS color swatch selectors updating PDP imagery instantly without page reloads.</p>
          </div>
        </div>
        <div class="fylla-value-item">
          <div class="fylla-value-icon-box">
          ...
          <div>
            <h3 class="fylla-value-h3">03 / AJAX Slide-Out Cart Drawer</h3>
            <p class="fylla-value-desc">Engineered an app-free cart drawer with upsell triggers and free shipping threshold meters.</p>
          </div>
        </div>
        <div class="fylla-value-item">
          <div class="fylla-value-icon-box">
          ...
          <div>
            <h3 class="fylla-value-h3">04 / Mobile Performance &amp; Speed Tuning</h3>
            <p class="fylla-value-desc">Optimized Liquid asset loading to achieve top-tier Google PageSpeed scores across mobile viewports.</p>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="c8cs-gallery-card">
            ...
            <div class="c8cs-gallery-card-bottom">
              ...
              <div class="c8cs-gallery-img-box">
                <img src="https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?q=80&w=800&auto=format&fit=crop" alt="Victorias Lane interface detail screenshot">
              </div>
            </div>
          </div>
          ...
          <div class="c8cs-gallery-card is-full">
            ...
            <div class="c8cs-gallery-card-bottom">
              ...
              <div class="c8cs-gallery-img-box is-tall">
                <img src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?q=80&w=1200&auto=format&fit=crop" alt="Victorias Lane mobile experience flow">
              </div>
            </div>
          </div>  </div>
        </div>
      ...
      <div class="c8cs-metrics-outer-box">
        ...
        <div class="c8cs-metrics-grid">
          <div class="c8cs-metric-card">
            ...
            <div class="c8cs-metric-lbl">Google PageSpeed Score</div>
            <p class="c8cs-metric-desc">Hand-coded Liquid architecture delivering ultra-fast shopping performance without template bloat.</p>
          </div>
          <div class="c8cs-metric-card">
            <div class="c8cs-metric-val">+38%</div>
            <div class="c8cs-metric-lbl">Average Order Value (AOV)</div>
            <p class="c8cs-metric-desc">Increased cart value via automated cross-sell prompts inside the custom AJAX cart drawer.</p>
          </div>

          <div class="c8cs-metric-card">
            <div class="c8cs-metric-lbl" style="margin-bottom: 1.5rem;">Live Verification</div>
            <a href="https://victoriaslane.com/" target="_blank" rel="noopener" class="c8cs-status-badge">
