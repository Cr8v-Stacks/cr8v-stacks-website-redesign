...
<main id="cr8v-main">
  <div class="hero-scroll-track" id="heroScrollTrack" style="height: 250vh; position: relative; margin-bottom: 2rem;">
    <section class="hero-arena-section" style="position: sticky; top: 85px; z-index: 100;">
