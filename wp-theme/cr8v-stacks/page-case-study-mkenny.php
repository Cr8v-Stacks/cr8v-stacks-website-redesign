<?php
/**
 * Template Name: Case Study — Mkenny Properties
 * Prototype Parity: Case Studies/mkenny-properties.html (100% Exact Duplication)
 */
    ...
    <div class="c8cs-wrap" style="padding-top: 1rem; padding-bottom: 2rem;">
      ...
      <div class="c8cs-meta-grid">
        <div class="c8cs-meta-item">
          ...
          <span class="c8cs-meta-val">Mkenny Properties</span>
        </div>
        <div class="c8cs-meta-item">
        ...
        <div class="c8cs-meta-item">
          ...
          <span class="c8cs-meta-val">WordPress · Elementor · PHP</span>
        </div>
        <div class="c8cs-meta-item">
          <span class="c8cs-meta-lbl">Link</span>
          <span class="c8cs-meta-val"><a href="https://mkennyproperties.com/" target="_blank" rel="noopener" style="color: #0047E1; text-decoration: underline;">mkennyproperties.com ↗</a></span>
        </div>
      </div>
    </div>
  </section>
