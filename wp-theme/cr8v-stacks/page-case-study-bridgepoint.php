<?php
/**
 * Template Name: Case Study — Bridgepoint Compliance
 * Prototype Parity: Case Studies/bridgepoint-consulting.html (100% Exact Duplication)
 */
...
<div class="c8cs-root">
  ...
  <section class="c8cs-hero">
    ...
    <div class="c8cs-wrap" style="padding-top: 1rem; padding-bottom: 2rem;">
      ...
      <div class="c8cs-label">Case Study // Corporate &amp; Custom Dev</div>
      <h1 class="c8cs-headline">Bridgepoint Advisory: Custom Compliance <span class="c8cs-serif">&amp; SQL App</span></h1>
      <p class="c8cs-lead">Bridgepoint Advisory Services required a high-security internal compliance web portal to streamline corporate auditing. We engineered a zero-template React and Node.js solution with custom relational database queries and role-based data encryption.</p>
      
      <div class="fylla-pill-row">
        <span class="fylla-pill">Custom Dev</span>
        <span class="fylla-pill">React &amp; Node</span>
        <span class="fylla-pill">PostgreSQL</span>
        <span class="fylla-pill">Data Security</span>
      </div>
      ...
      <div class="c8cs-meta-grid">
        ...
        <div class="c8cs-meta-item">
          ...
          <span class="c8cs-meta-val">Custom Development</span>
        </div>
        <div class="c8cs-meta-item">
          <span class="c8cs-meta-lbl">Stack</span>
          <span class="c8cs-meta-val">React · Node.js · SQL</span>
        </div>
        <div class="c8cs-meta-item">
  ...
  <div class="c8cs-grow-media-wrapper" id="c8cs-grow-trigger">
    <div class="c8cs-main-img-box" id="c8cs-grow-target">
      <img src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=1600&auto=format&fit=crop" alt="Bridgepoint Advisory showcase — built by Cr8v Stacks">
    </div>
  </div>
    ...
    <div class="c8cs-split-section">
      <div class="c8cs-split-left">
        ...
        <div class="c8cs-body-content">
          <p>Operating in high-tier financial consulting, Bridgepoint faced major bottlenecks managing client compliance audits using manual spreadsheets and generic cloud forms.</p>
          <p>They needed a dedicated internal compliance portal capable of parsing complex financial data models securely while maintaining zero latency across multi-user sessions.</p>
        </div>
      </div>
      ...
      <div class="c8cs-split-right">
        <div class="fylla-value-item">
          ...
          <div>
            <h3 class="fylla-value-h3">01 / Relational Database Architecture</h3>
            <p class="fylla-value-desc">Designed normalized PostgreSQL relational schemas optimized for high-speed audit record indexing.</p>
          </div>
        </div>
        <div class="fylla-value-item">
          <div class="fylla-value-icon-box">
          ...
          <div>
            <h3 class="fylla-value-h3">02 / Secure Authentication &amp; RBAC</h3>
            <p class="fylla-value-desc">Configured JWT multi-factor authentication with granular role-based access control for corporate compliance officers.</p>
          </div>
        </div>
        <div class="fylla-value-item">
          <div class="fylla-value-icon-box">
          ...
          <div>
            <h3 class="fylla-value-h3">03 / Custom Frontend Dashboard</h3>
            <p class="fylla-value-desc">Hand-coded a dark glassmorphic React admin interface featuring real-time data visualizers.</p>
          </div>
        </div>
        <div class="fylla-value-item">
          <div class="fylla-value-icon-box">
          ...
          <div>
            <h3 class="fylla-value-h3">04 / Automated Audit Reporting</h3>
            <p class="fylla-value-desc">Engineered background worker threads to automatically generate encrypted PDF compliance reports.</p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="c8cs-gallery-grid">
          <div class="c8cs-gallery-card">
            <div class="c8cs-gallery-card-top">
              <div class="c8cs-gallery-meta">Backend Architecture // Asset 01</div>
              <h3 class="c8cs-gallery-title">Engineered Database &amp; Compliance System</h3>
            </div>
            <div class="c8cs-gallery-card-bottom">
              <p class="c8cs-gallery-desc">Custom SQL database queries, data security encryption, and automated audit logging dashboard.</p>
              <div class="c8cs-gallery-img-box">
                <img src="https://images.unsplash.com/photo-1555066931-4365d14bab8c?q=80&w=800&auto=format&fit=crop" alt="Bridgepoint Advisory compliance database screenshot">
              </div>
            </div>
          </div>
          ...
          <div class="c8cs-gallery-card">
            ...
            <div class="c8cs-gallery-card-bottom">
              ...
              <div class="c8cs-gallery-img-box">
                <img src="https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?q=80&w=800&auto=format&fit=crop" alt="Bridgepoint Advisory interface detail screenshot">
              </div>
            </div>
          </div>
          ...
          <div class="c8cs-gallery-card is-full">
            ...
            <div class="c8cs-gallery-card-bottom">
              ...
              <div class="c8cs-gallery-img-box is-tall">
                <img src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?q=80&w=1200&auto=format&fit=crop" alt="Bridgepoint Advisory mobile experience flow">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="c8cs-metrics-outer-box">
        ...
        <div class="c8cs-metrics-grid">
          <div class="c8cs-metric-card">
            <div class="c8cs-metric-val">4x</div>
            <div class="c8cs-metric-lbl">Audit Review Velocity</div>
            <p class="c8cs-metric-desc">Accelerated corporate compliance file verification turnaround times from 5 business days down to 24 hours.</p>
          </div>
          <div class="c8cs-metric-card">
            <div class="c8cs-metric-val">0%</div>
            <div class="c8cs-metric-lbl">Template Overhead</div>
            <p class="c8cs-metric-desc">Built 100% from scratch with zero third-party plugin dependencies or security vulnerabilities.</p>
          </div>
    ...
    <div class="c8cs-wrap" style="padding-top:0; padding-bottom:0;">
      <div class="c8cs-related-matrix-box">
        ...
        <div class="c8cs-related-matrix-grid">
          <a href="<?php echo esc_url(home_url('/portfolio/wp-publishion-ai/')); ?>" class="c8cs-related-cell">
            <div>
              <div class="c8cs-related-cell-tag">01 / AI MVP Development</div>
              <h3 class="c8cs-related-cell-title">WP Publishion AI</h3>
              <p class="c8cs-related-cell-desc">Autonomous AI content engine powered by Python FastAPI, Claude API, OpenAI, and vector database retrieval.</p>
            </div>
          ...
          <a href="<?php echo esc_url(home_url('/portfolio/bridgepoints/')); ?>" class="c8cs-related-cell">
            <div>
              <div class="c8cs-related-cell-tag">03 / Brand Identity Design</div>
