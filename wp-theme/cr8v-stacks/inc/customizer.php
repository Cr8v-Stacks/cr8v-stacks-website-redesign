...
add_action('customize_register', function ($wp_customize) {
    ...
    $exact_services = [
        1 => ['title' => 'Website Design', 'desc' => 'High-converting digital experiences engineered for speed, search authority, and seamless user conversions. We design across every platform your business runs on — once the Figma design is approved, it gets handed to whichever build stack fits: WordPress, Shopify, WooCommerce, or fully custom code.', 'cta_text' => 'Explore Web Design', 'cta_url' => '/services/web-design/'],
        2 => ['title' => 'Custom Development', 'desc' => 'Tailored software architectures built from a blank file, engineered around your exact workflow. No templates, no SaaS dependencies, no monthly tool fees eating into your margin. When nothing off-the-shelf fits what you\'re building — this is where it starts.', 'cta_text' => 'Explore Custom Dev', 'cta_url' => '/services/custom-dev/'],
        3 => ['title' => 'AI MVP Products', 'desc' => 'Production-ready AI applications built to validate core business ideas with real users — not slide decks. We build AI-integrated products fast enough to get genuine market signal before you over-invest. When the idea validates, it hands directly into a full Custom Dev engagement.', 'cta_text' => 'Explore AI MVP', 'cta_url' => '/services/ai-mvp/'],
        4 => ['title' => 'Brand Strategy', 'desc' => 'Competitor analysis, pricing scoping, and messaging frameworks that give the rest of the build direction before a single pixel is designed. This is also the foundation every ad campaign and piece of content we run for you is built on — get this right first, and everything downstream gets easier and cheaper.', 'cta_text' => 'Explore Brand Strategy', 'cta_url' => '/services/brand-strategy/'],
        5 => ['title' => 'SEO & Content', 'desc' => 'Technical search work and content architecture that gets the site found. We fold SEO into every build from line one — but for sites that already exist, we audit, fix, and build the content layer that compounds over time. Paid acquisition works better once your organic foundation is solid.', 'cta_text' => 'Explore SEO & Content', 'cta_url' => '/services/seo-content/'],
        6 => ['title' => 'Digital Marketing', 'desc' => 'Multi-channel campaigns and lead acquisition retainers built on the positioning your Brand Strategy work defined. If you haven\'t done positioning work with us yet, we fold a lightweight version into campaign setup — but a full Brand Strategy engagement first means faster, cheaper testing.', 'cta_text' => 'Explore Digital Marketing', 'cta_url' => '/services/digital-marketing/']
    ];
