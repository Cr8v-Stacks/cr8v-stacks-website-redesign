<?php
/**
 * Template Name: Case Study — BLVCK Hair NG
 * Prototype Parity: Case Studies/blvck-hair-ng.html (100% Exact Duplication)
 */
...
<div class="c8cs-root">
  ...
  <section class="c8cs-hero">
    ...
    <div class="c8cs-wrap" style="padding-top: 1rem; padding-bottom: 2rem;">
      ...
      <div class="c8cs-label">Case Study // E-Commerce &amp; Organic Search</div>
      <h1 class="c8cs-headline">blvck Hair NG: Organic Revenue <span class="c8cs-serif">&amp; Entity SEO</span></h1>
      <p class="c8cs-lead">blvck Hair NG is a premier hair extension brand in Nigeria. We implemented an Entity SEO architecture, optimized technical crawl efficiency, and engineered semantic content clusters that drove a 400% surge in organic Google search traffic.</p>
      
      <div class="fylla-pill-row">
        <span class="fylla-pill">SEO &amp; Content</span>
        <span class="fylla-pill">Entity Schema</span>
        <span class="fylla-pill">Keyword Mapping</span>
        <span class="fylla-pill">E-Commerce SEO</span>
      </div>

      <div class="c8cs-meta-grid">
        <div class="c8cs-meta-item">
          <span class="c8cs-meta-lbl">Client</span>
          <span class="c8cs-meta-val">blvck Hair NG</span>
        </div>
        <div class="c8cs-meta-item">
          <span class="c8cs-meta-lbl">Services</span>
          <span class="c8cs-meta-val">SEO &amp; Content Strategy</span>
        </div>
        <div class="c8cs-meta-item">
          <span class="c8cs-meta-lbl">Stack</span>
          <span class="c8cs-meta-val">WordPress · WooCommerce · JSON-LD</span>
        </div>
        <div class="c8cs-meta-item">
          <span class="c8cs-meta-lbl">Link</span>
          <span class="c8cs-meta-val"><a href="https://blvckhair.ng/" target="_blank" rel="noopener" style="color: #0047E1; text-decoration: underline;">blvckhair.ng ↗</a></span>
        </div>
      </div>
    </div>
  </section>
  ...
  <div class="c8cs-grow-media-wrapper" id="c8cs-grow-trigger">
    <div class="c8cs-main-img-box" id="c8cs-grow-target">
      <img src="https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?q=80&w=1600&auto=format&fit=crop" alt="blvck Hair NG showcase — built by Cr8v Stacks">
    </div>
  </div>
    ...
    <div class="c8cs-split-section">
      <div class="c8cs-split-left">
        ...
        <div class="c8cs-body-content">
          <p>In a fiercely competitive e-commerce niche, blvck Hair NG was paying steep ad acquisition costs to acquire customers on social media platforms.</p>
          <p>They needed a sustainable organic search engine channel to rank on Google Page 1 for high-intent commercial keywords like 'human hair extensions Lagos'.</p>
        </div>
      </div>
      ...
      <div class="c8cs-split-right">
        <div class="fylla-value-item">
          ...
          <div>
            <h3 class="fylla-value-h3">01 / Technical SEO Audit &amp; Crawl Fixes</h3>
            <p class="fylla-value-desc">Resolved crawl budget bottlenecks, fixed broken internal links, and accelerated mobile LCP page load speed.</p>
          </div>
        </div>
        <div class="fylla-value-item">
          <div class="fylla-value-icon-box">
          ...
          <div>
            <h3 class="fylla-value-h3">02 / Semantic Keyword &amp; Entity Mapping</h3>
            <p class="fylla-value-desc">Mapped high-intent commercial search queries to dedicated category archives and product detail pages.</p>
          </div>
        </div>
        <div class="fylla-value-item">
          <div class="fylla-value-icon-box">
          ...
          <div>
            <h3 class="fylla-value-h3">03 / Schema JSON-LD Structured Data</h3>
            <p class="fylla-value-desc">Injected Product, Offer, and Organization JSON-LD schema markup directly into page headers.</p>
          </div>
        </div>
        <div class="fylla-value-item">
          <div class="fylla-value-icon-box">
          ...
          <div>
            <h3 class="fylla-value-h3">04 / Authority Content Clusters</h3>
            <p class="fylla-value-desc">Published comprehensive hair care guides and buying manuals to establish topical domain authority.</p>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="c8cs-gallery-card">
            ...
            <div class="c8cs-gallery-card-bottom">
              ...
              <div class="c8cs-gallery-img-box">
                <img src="https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?q=80&w=800&auto=format&fit=crop" alt="Blvck Hair NG interface detail screenshot">
              </div>
            </div>
          </div>
          ...
          <div class="c8cs-gallery-card is-full">
            ...
            <div class="c8cs-gallery-card-bottom">
              ...
              <div class="c8cs-gallery-img-box is-tall">
                <img src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?q=80&w=1200&auto=format&fit=crop" alt="Blvck Hair NG mobile experience flow">
              </div>
            </div>
          </div>  </div>
        </div>
      ...
      <div class="c8cs-metrics-outer-box">
        ...
        <div class="c8cs-metrics-grid">
          <div class="c8cs-metric-card">
            <div class="c8cs-metric-val">+400%</div>
            <div class="c8cs-metric-lbl">Organic Search Growth</div>
            <p class="c8cs-metric-desc">Engineered rank velocity pushing top commercial keywords into Google top 3 organic positions.</p>
          </div>
          <div class="c8cs-metric-card">
            <div class="c8cs-metric-val">3.8x</div>
            <div class="c8cs-metric-lbl">Organic Return on Investment</div>
            <p class="c8cs-metric-desc">Generated consistent monthly revenue without ongoing ad spend reliance.</p>
          </div>

          <div class="c8cs-metric-card">
            <div class="c8cs-metric-lbl" style="margin-bottom: 1.5rem;">Live Verification</div>
            <a href="https://blvckhair.ng/" target="_blank" rel="noopener" class="c8cs-status-badge">
      ...
      <div class="c8cs-related-matrix-box">
        ...
        <div class="c8cs-related-matrix-grid">
          <a href="<?php echo esc_url(home_url('/portfolio/the-duch-apartments/')); ?>" class="c8cs-related-cell">
            <div>
              <div class="c8cs-related-cell-tag">01 / Web Design &amp; SEO</div>
          ...
          <a href="<?php echo esc_url(home_url('/portfolio/stride-plus-media/')); ?>" class="c8cs-related-cell">
            <div>
              ...
              <p class="c8cs-related-cell-desc">Growth and search marketing web application with conversion rate optimization architecture.</p>
            </div>
            <span class="c8cs-related-cell-link">Explore Case Study &rarr;</span>
          </a>
