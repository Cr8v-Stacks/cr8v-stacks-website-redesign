...
<head>
  ...
  <style>
    ...
    * {
    ...
    /* ── ARCHITECTURAL PAPER GRID META MATRIX (Zero-Gap Tiling) ── */
    .c8cs-meta-grid {
      display: grid;
    ...
    /* ── OVERVIEW SPLIT SECTION (STICKY LEFT COLUMN & ARCHITECTURAL PAPER GRID) ── */
    .c8cs-split-section {
      display: grid;
      ...
      background: #FFFFFF;
      margin: 4rem 0;
      /* IMPORTANT: NO overflow:hidden HERE so position:sticky works! */
    }
    ...
    /* Approach Item Cell Matrix (Zero-Gap Tiling) */
    .fylla-value-item {
      padding: 3rem 3.5rem;
      border-bottom: 1px solid var(--c8-grid-line);
      display: flex;
    ...
    /* ── ARCHITECTURAL PAPER GRID SHOWCASE GALLERY MATRIX ── */
    ...
    /* ── ARCHITECTURAL PAPER GRID RELATED PROJECTS MATRIX ── */
      ...
      <div class="c8cs-wrap" style="padding-top:0; padding-bottom:0;">
        <div class="c8cs-related-matrix-box">
          ...
          <div class="c8cs-related-matrix-grid">
            <!-- Cell 1 -->
            <a href="kiri-city-stays.html" class="c8cs-related-cell">
              <div>
            ...
            <!-- Cell 2 -->
            <a href="bridgepoint-consulting.html" class="c8cs-related-cell">
              <div>
            ...
            <!-- Cell 3 -->
            <a href="mkenny-properties.html" class="c8cs-related-cell">
              <div>
