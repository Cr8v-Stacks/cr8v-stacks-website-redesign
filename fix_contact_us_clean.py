...
.c8ct-h1 { font-family:'Michroma',sans-serif; font-size:2.2rem; line-height:1.15; color:var(--ink); letter-spacing:.01em; max-width:18ch; margin-bottom:.85rem; font-weight:700; }
.c8ct-lede { font-size:14.5px; line-height:1.6; color:#4a4a4a; font-weight:300; max-width:38ch; font-family:'DM Sans',sans-serif; }
...
@media (max-width:768px){
  ...
  .c8ct-h1 { font-size:1.8rem; max-width:none; }
